...
const portfolioProjects = [
  {
    ...
    link: "https://gravitygsapproject.netlify.app/",
    image: darkSaasLandingPage,
  },
  {
    company: "Luminar Technolab",
    year: "2024",
    title: "Clone Webpages",
    results: [
      { title: "Boosted sales by 20%" },
      { title: "Expanded customer reach by 35%" },
      { title: "Increased brand awareness by 15%" },
    ],
    link: "https://clone-phonepesite.netlify.app/",
  ...
  },
  {
    ...
    link: "https://bmicalculatortask.netlify.app/",
...
export const ProjectsSection = () => {
  ...
  <section className="pb-16 lg:py-24">
    <div className="container">
      ...
      See how I transformed concepts into engaging digital experiences.</p>
      <div className="mt-10 md:mt-20 flex flex-col gap-20">
        {portfolioProjects.map(project => (
          <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 
              ...
              after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 pt-8 md:pt-12 md:px-10
